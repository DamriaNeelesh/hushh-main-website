...
const PLAID_URLS = {
  production: "https://production.plaid.com/investments/refresh",
  sandbox: "https://sandbox.plaid.com/investments/refresh",
};
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ error: error?.message || "Investments refresh error" }, { status: 500 });
  }
}
