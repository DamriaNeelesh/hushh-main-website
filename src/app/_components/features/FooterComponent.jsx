        ...
        <div className="desktop-view">
          <footer>
            <section aria-labelledby="footer-about">
              <h2 id="footer-about">About Hushh</h2>
              <p>Future of “Digital Identity” & “Personalised Experiences”</p>
              <p>Call <a href="tel:+14252969050">+14252969050</a></p>
            </section>
            <section aria-labelledby="footer-links">
              <h2 id="footer-links">Quick Links</h2>
              <ul>
                <li><Link href="/products/hushhWalletApp">Hushh Wallet App</Link></li>
                <li><Link href="/products/hushhButton">Hushh Button</Link></li>
                <li><Link href="/products/vibeSearch">Vibe Search</Link></li>
                <li><Link href="/products/browserCompanion">Browser Companion</Link></li>
                <li><Link href="/developerApi">Developer API</Link></li>
                <li><Link href="/products/hushhForStudents">HFS App</Link></li>
              </ul>
            </section>
            <section aria-labelledby="footer-company">
              <h2 id="footer-company">Company</h2>
              <ul>
                <li><Link href="/demoBookingPage">Free Demo</Link></li>
                <li><Link href="https://hushh-labs.github.io/hushh-labs-blog/">Blog</Link></li>
                <li><Link href="https://www.linkedin.com/company/hushh-ai/jobs/">Careers</Link></li>
            ...
            <section aria-labelledby="footer-resources">
              ...
              <ul>
                <li><Link href="/demoBookingPage">Live Demonstration</Link></li>
              </ul>
            </section>
            <section aria-labelledby="footer-legal">
              <h2 id="footer-legal">Legal</h2>
              <ul>
                <li><Link href="/legal/termsofuse">Terms of Service</Link></li>
                <li><Link href="/legal/privacypolicy">Privacy Policy</Link></li>
              </ul>
            </section>
              ...
              <div className="flex flex-col gap-4 text-center mt-5">
                ...
                <div className="flex items-center justify-center gap-5 h-full">
                  <button
                    ...
                    className="flex flex-1 hover:border-none justify-center px-4 py-2 gap-1.5 border border-myBorder rounded-full"
                  >
                    Download Hushh App
                  </button>
                </div>
