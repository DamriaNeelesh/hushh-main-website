...
const PhoneVerificationPage = () => {
  ...
  const [phoneNumber, setPhoneNumber] = useState('+91 4923021893');
    ...
    return (
      ...
      >
        <Box width="100%" px={6}>
          ...
          <Box mb={8}>
            <Flex mb={6} width="100%" alignItems="center" flexDirection="column">
              <Box 
                bg="gray.100" 
                py={2.5} 
                px={4} 
            ...
            <Box mb={4}>
              <Text mb={4} fontWeight="medium" fontSize="xs" color="gray.800">
...
const VerificationForm = ({ phoneNumber, otp, inputRefs, handleOtpChange, handleKeyDown, handleContinue, isMobile }) => {
  return (
