...
describe("TranslationDemo", () => {
  ...
  it("renders hushh.Bhasha badge", () => {
    render(<TranslationDemo />);
    expect(
      screen.getByText("🌐 hushh.Bhasha — भाषा (Language)")
    ).toBeInTheDocument();
  });
...
describe("ContentGeneratorDemo", () => {
  ...
  it("renders Powered by hushh AI badge", () => {
    render(<ContentGeneratorDemo />);
    expect(
      screen.getByText("Powered by hushh AI")
    ).toBeInTheDocument();
  });
  ...
  it("renders model switcher with hushh.Kavi and hushh.Rasa", () => {
    render(<ContentGeneratorDemo />);
    expect(screen.getByText("hushh.Kavi")).toBeInTheDocument();
    expect(screen.getByText("hushh.Rasa")).toBeInTheDocument();
  });

  it("renders Generate button with default model name", () => {
    render(<ContentGeneratorDemo />);
    expect(
      screen.getByText("Generate with hushh.Kavi")
    ).toBeInTheDocument();
  });

  it("Generate button is disabled when brand/topic empty", () => {
    render(<ContentGeneratorDemo />);
    const btn = screen.getByText("Generate with hushh.Kavi").closest("button");
    expect(btn).toBeDisabled();
  });
  ...
  it("calls the generate API with hushhModel on button click", async () => {
    global.fetch.mockResolvedValueOnce({
      json: () =>
        Promise.resolve({
          success: true,
    ...
    fireEvent.click(
      screen.getByText("Generate with hushh.Kavi").closest("button")
    );
  ...
  it("displays generated content with hushh model name", async () => {
    global.fetch.mockResolvedValueOnce({
      json: () =>
        Promise.resolve({
          success: true,
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByText(/Generated by hushh\.Kavi/)
      ).toBeInTheDocument();
    });
  });
...
describe("VoiceSearchDemo", () => {
  ...
  it("renders hushh.Shruti badge", () => {
    render(<VoiceSearchDemo />);
    expect(
      screen.getByText("🎙️ hushh.Shruti — श्रुति (Hearing)")
    ).toBeInTheDocument();
  });
